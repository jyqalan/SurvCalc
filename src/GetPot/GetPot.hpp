// const char* getpot_hpp_id = "$Id: GetPot.hpp 237 2008-08-14 21:50:06Z fud $\n";
...
private:
    ...
    inline void          skip_whitespace(istream& istr);
    inline const string  get_next_token(istream& istr);
    inline const string  get_string(istream& istr);
    inline void          parse_argv(vector<string>& ARGV);
    inline void          read_in_stream(istream& istr);
...
inline void
GetPot::read_in_stream(istream& istr)
{
...
inline void
GetPot::skip_whitespace(istream& istr)
{
    int tmp = istr.get();
    do {
        while( isspace(tmp) ) {
...
inline const string
GetPot::get_next_token(istream& istr)
...
inline const string
GetPot::get_string(istream& istr)
